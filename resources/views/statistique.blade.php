                        ...
                        <div class="row">
                            <div class="col-xl-6 ">
                                <div class="card m-b-30 " style="background-color:white !important">
                                    <div class="card-body">
                                        <div class="float-right"> AMIO <input type="checkbox" id="amioCheckboxRz"></div>
                                        <h4 class="mt-0 header-title mb-4" style="color:rgb(100, 69, 30)">Réceptions {{ date("Y") }} par zone</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="card m-b-30 " style="background-color: white !important">
                                    <div class="card-body" >
                                        <h4 class="mt-0 header-title mb-4" style="color:rgb(100, 69, 30)">Réceptions année {{ date("Y") }}  par moi</h4>

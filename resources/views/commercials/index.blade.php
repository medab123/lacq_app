...
@section('content')
    ...
    <form method="post" id="modalModal" action="{{ url('/commercials') }}" enctype="multipart/form-data">
        <div class="modal fade bd-example-modal-lg" id="modalEditCommercial" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group input-group-sm col-md-4">
                                ...
                                <input id="zone" type="text" class="form-control @error('zone') is-invalid @enderror"
                                    name="zone" value="{{ old('zone') }}" required autocomplete="zone" autofocus>
                            </div>
                            <div class="form-group input-group-sm col-md-4">
                    ...
                    <tbody>
                        @foreach ($listCommercials as $commercial)
                            <tr>
                                ...
                                <td id='zone' class="text-center"><span

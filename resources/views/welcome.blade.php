            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- end col -->
                        <div class="col-xl-6 ">
                            <div class="card m-b-30 " style="padding-bottom: 22px;background-color: rgb(5, 11, 54) !important">
                                <div class="card-body ">
                                    <h4 class="mt-0 header-title mb-4" style="color:bisque">Les analyses par matrice</h4>

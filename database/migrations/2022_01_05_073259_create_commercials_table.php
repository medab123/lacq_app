...
class CreateCommercialsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('commercials')->insert(
            array(
                array('id' => '1','name' => 'MOHAMMED ELABIDI ','zone' => 'SOUSS-MASSA'),
                array('id' => '2','name' => 'ELABIDI MOHAMMED','zone' => 'SOUSS-MASSA'),
                array('id' => '3','name' => 'AMINE TEST','zone' => 'SOUSS-MASSA'),
                array('id' => '4','name' => 'MUSTAPHA  TEST2','zone' => 'SOUSS-MASSA'),
                array('id' => '5','name' => 'MOHAMMED TEST','zone' => 'SOUSS-MASSA'),
                array('id' => '6','name' => 'AIT M\'HAMED TEST','zone' => 'SOUSS-MASSA'),
                array('id' => '7','name' => 'BENTAARITE MED TEST','zone' => 'SOUSS-MASSA'),
                array('id' => '8','name' => 'IDRISS EL TEST','zone' => 'SOUSS-MASSA'),
                array('id' => '9','name' => 'TOUIL TEST ','zone' => 'TARDOUDANT-OUARZAZATE'),
                array('id' => '10','name' => 'ABDELKARIM TEST','zone' => 'TARDOUDANT-OUARZAZATE'),
                array('id' => '11','name' => 'AHMAD TEST','zone' => 'TARDOUDANT-OUARZAZATE'),
                array('id' => '12','name' => 'HICHAM TEST','zone' => 'TARDOUDANT-OUARZAZATE'),
                array('id' => '13','name' => 'HAMID TEST','zone' => 'TARDOUDANT-OUARZAZATE'),
                array('id' => '14','name' => 'ABDELALI TEST ','zone' => 'GHARB'),
                array('id' => '15','name' => 'AZOUGAGH TEST ','zone' => 'GHARB'),
                array('id' => '16','name' => 'BOUCHTA TEST ','zone' => 'GHARB'),
                array('id' => '17','name' => 'MOUHSINE TEST ','zone' => 'GHARB'),
                array('id' => '18','name' => 'ALI AIT TEST ','zone' => 'ATLAS-DRAA'),
                array('id' => '19','name' => 'ABDELAH TEST ','zone' => 'ATLAS-DRAA'),
                array('id' => '20','name' => 'MOHAMMED TEST TEST ','zone' => 'ATLAS-DRAA'),
                array('id' => '21','name' => 'HASSANE TEST','zone' => 'ATLAS-DRAA'),

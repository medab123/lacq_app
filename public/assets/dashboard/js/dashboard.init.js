    ...
    ! function($) {
        ...
        Dashboard.prototype.table = function(elementID, data) {
            ...
            Dashboard.prototype.init = function() {
                $.getJSON('http://localhost:8000/top5Commercial', function(data) {
                    Dashboard.prototype.top5Commercial($("#top5commercial"), data);
                });
                $.getJSON('http://localhost:8000/commercialTable', function(data) {
                ...
                $.getJSON('http://localhost:8000/CommandeByMatrice', function(data) {
                    var $donutData = data;
